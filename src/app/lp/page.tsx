      ...
      <section className="section section--blue">
        <div className="container">
          <div className="pricing-header">
            <button className="btn btn--primary eyebrow">企業規模や目的に応じて選べる！</button>
          ...
          <div className="pricing-table-wrapper">
            <table className="pricing-table">
              <thead>
                <tr>
                  <th className="table-header" colSpan={3}>プラン名</th>
                  <th className="table-header table-header--light">
                    <span className="table-header__subtitle">試験的に海外展開を始めたい</span>
                    ライトプラン
                  </th>
                  <th className="table-header table-header--light">
                    <span className="table-header__subtitle">基本的なサービスが揃ってる</span>
                    スタンダードプラン
                  </th>
                  <th className="table-header table-header--light">
                    <span className="table-header__subtitle">まるっとお任せしたい</span>
                    プレミアムプラン
                  </th>
                </tr>
              </thead>
              <tbody>
                ...
                <tr>
                  ...
                  <td className="table-cell table-cell--feature" rowSpan={3}>戦略設計</td>
                  <td className="table-cell table-cell--feature">市場・商品分析</td>
                  <td className="table-cell table-cell--center">○</td>
                  <td className="table-cell table-cell--center">○</td>
                  <td className="table-cell table-cell--center">○</td>
                </tr>
                <tr>
                  <td className="table-cell table-cell--feature">KPIレポート提出<p className="note">※月1回</p></td>
                  <td className="table-cell table-cell--center">×</td>
                  <td className="table-cell table-cell--center">○</td>
                  <td className="table-cell table-cell--center">○</td>
                </tr>
                <tr>
                  <td className="table-cell table-cell--feature">CRM導入支援</td>
                  <td className="table-cell table-cell--center">×</td>
                  <td className="table-cell table-cell--center">×</td>
                  <td className="table-cell table-cell--center">○</td>
                </tr>
                <tr>
                  <td className="table-cell table-cell--feature" rowSpan={3}>EC・LP構築</td>
                ...
                <tr>
                  <td className="table-cell table-cell--feature">EC構築</td>
                  <td className="table-cell table-cell--center">×</td>
                  <td className="table-cell table-cell--center">○</td>
                  <td className="table-cell table-cell--center">○</td>
                </tr>
                <tr>
                  <td className="table-cell table-cell--feature">問い合わせフォーム設計</td>
                  <td className="table-cell table-cell--center">×</td>
                  <td className="table-cell table-cell--center">×</td>
                  <td className="table-cell table-cell--center">○</td>
                </tr>
                <tr>
                  <td className="table-cell table-cell--feature" rowSpan={2}>翻訳・ローカライズ</td>
                  <td className="table-cell table-cell--feature">商品翻訳<p className="note">※日本語→英語/ドイツ語</p></td>
                  <td className="table-cell table-cell--center">○</td>
                  <td className="table-cell table-cell--center">○</td>
                  <td className="table-cell table-cell--center">○</td>
                </tr>
                <tr>
                  <td className="table-cell table-cell--feature">ECサイトの多言語対応<p className="note">※日本語/英語/ドイツ語</p></td>
                  <td className="table-cell table-cell--center">×</td>
                  <td className="table-cell table-cell--center">×</td>
                  <td className="table-cell table-cell--center">○</td>
                </tr>
                <tr>
                  <td className="table-cell table-cell--feature" rowSpan={2}>SNS・広告運用代行</td>
                  <td className="table-cell table-cell--feature">SNS広告初期設定</td>
                  <td className="table-cell table-cell--center">○</td>
                  <td className="table-cell table-cell--center">○</td>
                  <td className="table-cell table-cell--center">○</td>
                </tr>
                <tr>
                  <td className="table-cell table-cell--feature">SNS広告運用代行</td>
                  <td className="table-cell table-cell--center">×</td>
                  <td className="table-cell table-cell--center">○</td>
                  <td className="table-cell table-cell--center">○</td>
                </tr>
                <tr>
                  <td className="table-cell table-cell--feature" rowSpan={2}>現地サポート</td>
                  <td className="table-cell table-cell--feature">現地カスタマー対応</td>
                  <td className="table-cell table-cell--center">×</td>
                  <td className="table-cell table-cell--center">○</td>
                  <td className="table-cell table-cell--center">○</td>
                </tr>
                <tr>
                  <td className="table-cell table-cell--feature">現地市場に合わせた改善提案<p className="note">※レポート×改善会議</p></td>
                  <td className="table-cell table-cell--center">×</td>
                  <td className="table-cell table-cell--center">×</td>
                  <td className="table-cell table-cell--center">○</td>
                </tr>
          ...
          <div className="pricing-footer">
            ...
            <table className="pricing-footer__table">
              <tbody>
                <tr>
                  <th>オプション<span>¥50,000〜 /月</span></th>
                  <td>
        ...
        <div className="container">
          ...
          <div className="lp-case-studies-grid">
            <div className="lp-case-study-card">
              <p className="lp-case-study__categori lp-case-study__categori_ec">EC制作</p>
            ...
            <div className="lp-case-study-card">
              <p className="lp-case-study__categori lp-case-study__categori_sns">SNS運用</p>
              <div className="lp-case-study-image">
                <Image
